...
df = pd.read_pickle("data/CLARA.pkl")
...
df_dec2020.to_pickle("data/CLARA_matched.pkl")

df_plot = df_dec2020[["TimeJD", "CLARA_radiance", "CLARA_fov_longitude", "CLARA_fov_latitude"]].dropna()
